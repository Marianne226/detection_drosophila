import numpy as np
import cv2 as cv
from dataAcq_func_magnet import *


in_path = '/Users/mariannecivitardevol/Documents/EPFL/Masters/projet semestre1/tracking_code/Training classifier/new_videos_brightness/20240524-150818.mp4'
...
while True:
    ...
    if count % 186 == 0: #frequency at which we want to collect a frame 
        ...
        if ret == True:
            ...
            if count == 0:
                fly_id = determine_fly_robot2(contours)
                robotID = (fly_id + 1) % 2
            contour_fly = contours[fly_id]
            final = approximate_to_ellipse(contour_fly, frame)
